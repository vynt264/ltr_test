...
@Controller("/api/v1/admin-sys-layout")
@ApiTags("AdminSysLayout")
export class AdminSysLayoutController {
  constructor(private adminSysLayoutService: AdminSysLayoutService) {}
  ...
  async GetAll(): Promise<any> {
    return this.adminSysLayoutService.getAll();
  }
  ...
  async create(
    ...
    return this.adminSysLayoutService.create(userDto, req?.user);
  }
  ...
  async updateSysLayout(
    ...
    return this.adminSysLayoutService.update(id, updateDto, req?.user);
  }
  ...
  async delete(@Param("id") id: number): Promise<any> {
    return this.adminSysLayoutService.delete(id);
  }
  ...
  async uploadFile(@UploadedFile() image: Express.Multer.File): Promise<any> {
    return this.adminSysLayoutService.uploadImage(image);
  }
}
